import { addProfile, deleteProfile, useFetchProfiles, useListAccounts, useListProfiles } from "@/api/api";
import { Button, Card, Col, Dropdown, Input, message, Row, Skeleton, Tag, Typography } from "antd";
import { useXTheme, XFlex, XImage, XList, XTag, XText } from "@pro/ui";
...
const ProfileList = ({
    ...
    const onDelete = (item: any) => {
        deleteProfile({ id: item._id }).then((res) => {
            if (!res.code) {
