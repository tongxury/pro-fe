...
import IconXiaohongshu from './IconXiaohongshu';
import IconDouyin from './IconDouyin';
import IconVip1 from './IconVip1';
import IconVip3 from './IconVip3';
import IconShandian from './IconShandian';
import IconEditFill from './IconEditFill';
import IconEditLine from './IconEditLine';
import IconDeleteBin6Line from './IconDeleteBin6Line';
import IconDeleteBin6Fill from './IconDeleteBin6Fill';
import IconCustomerService2Fill from './IconCustomerService2Fill';
import IconFileListFill from './IconFileListFill';
import IconFilePaperFill from './IconFilePaperFill';
import IconWalletFill from './IconWalletFill';
import IconStarLine from './IconStarLine';
...
export { default as IconVip3 } from './IconVip3';
export { default as IconShandian } from './IconShandian';
export { default as IconEditFill } from './IconEditFill';
export { default as IconEditLine } from './IconEditLine';
export { default as IconDeleteBin6Line } from './IconDeleteBin6Line';
export { default as IconDeleteBin6Fill } from './IconDeleteBin6Fill';
export { default as IconCustomerService2Fill } from './IconCustomerService2Fill';
export { default as IconFileListFill } from './IconFileListFill';
export { default as IconFilePaperFill } from './IconFilePaperFill';
export { default as IconWalletFill } from './IconWalletFill';
export { default as IconStarLine } from './IconStarLine';
...
export type IconNames = 'tiktok' | 'xiaohongshu' | 'douyin' | 'vip1' | 'vip3' | 'shandian' | 'edit-fill' | 'edit-line' | 'delete-bin-6-line' | 'delete-bin-6-fill' | 'customer-service-2-fill' | 'file-list-fill' | 'file-paper-fill' | 'wallet-fill' | 'star-line' | 'send-fill' | 'stock-fill' | 'gas-station-fill' | 'arrow-down-s-line' | 'arrow-left-s-line' | 'arrow-right-s-line' | 'arrow-up-s-line' | 'money-euro-circle-line' | 'money-euro-circle-fill' | 'arrow-left-line' | 'add-circle-fill' | 'add-circle-line' | 'settings-line' | 'settings-fill' | 'checkbox-circle-fill' | 'copy-fill' | 'close-circle-fill' | 'star-fill' | 'search-line' | 'arrow-drop-down-fill' | 'arrow-drop-left-fill' | 'arrow-drop-right-fill' | 'arrow-drop-up-fill' | 'function-fill' | 'palette-fill' | 'gift-fill' | 'money-dollar-box-fill' | 'information-fill' | 'shield-keyhole-fill' | 'account-circle-fill' | 'wallet-3-fill' | 'hearts-fill' | 'hearts-line' | 'money-dollar-circle-fill' | 'home-5-fill' | 'group-fill' | 'group-line';
...
const IconFont: FunctionComponent<Props> = ({ name, ...rest }) => {
  switch (name) {
    case 'tiktok':
      return <IconTiktok {...rest} />;
    case 'xiaohongshu':
      return <IconXiaohongshu {...rest} />;
    case 'douyin':
      return <IconDouyin {...rest} />;
    case 'vip1':
      return <IconVip1 {...rest} />;
    case 'vip3':
      return <IconVip3 {...rest} />;
    case 'shandian':
      return <IconShandian {...rest} />;
    case 'edit-fill':
      return <IconEditFill {...rest} />;
    case 'edit-line':
      return <IconEditLine {...rest} />;
    case 'delete-bin-6-line':
      return <IconDeleteBin6Line {...rest} />;
    case 'delete-bin-6-fill':
      return <IconDeleteBin6Fill {...rest} />;
    case 'customer-service-2-fill':
      return <IconCustomerService2Fill {...rest} />;
    case 'file-list-fill':
      return <IconFileListFill {...rest} />;
    case 'file-paper-fill':
      return <IconFilePaperFill {...rest} />;
    case 'wallet-fill':
      return <IconWalletFill {...rest} />;
    case 'star-line':
      return <IconStarLine {...rest} />;
    case 'send-fill':
