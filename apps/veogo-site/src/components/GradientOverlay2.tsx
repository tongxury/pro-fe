...
// 透明中间+渐变边缘的覆盖层组件
const GradientOverlay = ({children}: { children: any }) => {
    ...
    const overlayStyle = {
        ...
        background: `
      linear-gradient(to right, ${themeVars.colorBgPrimary} 0%, rgba(0, 0, 0, 0) 40%, rgba(0, 0, 0, 0) 60%, ${themeVars.colorBgPrimary}  100%)
    `,
