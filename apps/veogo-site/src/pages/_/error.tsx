...
-----------------------------`;
    ...
    const linkStyle = { /* ... 样式与之前相同 ... */
        display: 'inline-block', marginTop: '1.5rem', padding: '12px 28px', backgroundColor: '#007aff',
        color: '#ffffff', textDecoration: 'none', borderRadius: '12px', fontWeight: '600',
        boxShadow: '0 4px 15px rgba(0, 122, 255, 0.2), 0 0 0 1px rgba(255, 255, 255, 0.1) inset',
