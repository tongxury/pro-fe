...
const Templates = ({ data, onChange }: {
    ...
    const { data: dr, loading } = useRequest(() => listPublicTemplates({
    ...
    return (
        <div className="flex flex-col gap-4 animate-fade-in">
            <Tabs
                ...
                onChange={(key) => setTemplateType(key as 'system' | 'custom')}
                items={[
                    { label: '系统模板', key: 'system' },
                    { label: '我的模板', key: 'custom' },
                ]}
            ...
            {templateType === 'system' ? (
                ...
                <MyTemplates data={data} onChange={onChange} />
            )}
        </div>
    );
}
