...
import {useClientOnce} from "@pro/hooks";
...
export function useTelegramMock(): void {
    useClientOnce(() => {
        ...
        if (shouldMock) {
            ...
            // ]).toString();
            // const initDataRaw = "tma query_id=AAFy72VFAgAAAHLvZUVrvNlS&user=%7B%22id%22%3A5459275634%2C%22first_name%22%3A%22Cc%22%2C%22last_name%22%3A%22Dd%22%2C%22language_code%22%3A%22zh-hans%22%2C%22allows_write_to_pm%22%3Atrue%7D&auth_date=1728659386&hash=c5f28b66cf15c66ff4b6d92d9253c7a0976160bd6f02fdf0974ec028087c2b6d"

            const initDataRaw = import.meta.env.VITE_MOCK_AUTH;
            ...
            // sessionStorage.setItem("____mocked_initData", initDataRaw);
